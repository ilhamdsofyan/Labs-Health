...
*/
$autoload['libraries'] = array('layout', 'session', 'database', 'helpers', 'html', 'menuhelper', 'form_validation', 'CustomException');
...
*/
$autoload['helper'] = array('url', 'form', 'hris', 'security');
...
function my_load($class)
{
	...
	$path = APPPATH . 'core/traits/' . $class . '.php';
    if (file_exists($path)) {
        require_once $path;
    }
}
