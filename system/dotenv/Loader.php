...
class Loader
{
    ...
    /**
	 * Read lines from the file, safely handling line endings.
	 *
	 * @param string $filePath
	 *
	 * @return array
	...
	protected function readLinesFromFile($filePath)
	{
		...
		// Normalize all line endings ke \n
		$contents = str_replace(["\r\n", "\r"], "\n", $contents);

		// Split per line, filter kosong
		$lines = array_filter(explode("\n", $contents), fn($line) => trim($line) !== '');

		return array_values($lines); // biar index-nya rapih dari 0
	}
