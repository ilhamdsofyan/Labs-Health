<?php
require_once APPPATH . 'libraries/array/Arrayhelper.php';
...
class Html
{
    ...
    {
        return static::tag('meta', '', ['name' => 'csrf-param', 'content' => $this->CI->security->get_csrf_token_name()]) . "\n"
            . static::tag('meta', '', ['name' => 'csrf-token', 'content' => $this->CI->security->get_csrf_hash()]) . "\n";
    ...
    public static function img($src, $options = [])
    {
        ...
        if (isset($options['srcset']) && is_array($options['srcset'])) {
            ...
            foreach ($options['srcset'] as $descriptor => $url) {
                $srcset[] = base_url($url) . ' ' . $descriptor;
            }
