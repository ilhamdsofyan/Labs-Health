...
$this->layout->setSection('subtitle', 'Routes');
            ...
            <div class="card-body">
            	<div class="row">
		            <div class="col-sm-5">
		                <div class="input-group input-group-joined mb-3">
		                    ...
		                    <span class="input-group-btn">
		                        <?= $this->html->a('<i data-feather="refresh-cw"></i>', '/rbac/route/refresh', [
		                            'class' => 'btn btn-light',
		                            'id' => 'btn-refresh'
		                        ]) ?>
		                    </span>
		            ...
		            <div class="col-sm-2 text-center">
		                <br><br>
		                <?= $this->html->a('<i data-feather="chevrons-right"></i>', '/rbac/route/assign', [
		                    'class' => 'btn btn-success btn-assign',
		                    'data-target' => 'available',
		                    'title' => 'Assign',
		                ]) ?><br><br>
		                <?= $this->html->a('<i data-feather="chevrons-left"></i>', '/rbac/route/remove', [
